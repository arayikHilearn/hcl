...
const initialState: TChartsData = {
    expected: {
        annualData: {
            ...
            hclCumulativePayment: data2.annual_data.hcl_cumulative_payment,
            conventionalCumulativePayment: data2.annual_data.conventional_cumulative_payment,
            hclLoanBalance: data2.annual_data.hcl_loan_balance,
            conventionalLoanBalance: data2.annual_data.conventional_loan_balance,
        }
    },
    best: null,
    worst: null
